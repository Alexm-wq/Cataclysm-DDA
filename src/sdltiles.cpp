    ...
    if( draw_terrain_tiles || draw_preview_tiles ) {
        ...
        if( draw_preview_tiles ) {
            ...
            if( debug_last_center_x != tile_draw_center.x() ||
                ...
                DebugLog( D_INFO, D_MAIN ) << "[VEH_LIVE_RENDER] draw logical_center=("
            ...
            case SDL_MOUSEBUTTONDOWN:
                ...
                switch( ev.button.button ) {
                    ...
                    case SDL_BUTTON_MIDDLE:
                        last_input = sdl_mouse_button_event( MouseInput::MiddleButtonPressed );
                        break;
                    case SDL_BUTTON_X1:
            ...
            case SDL_MOUSEBUTTONUP:
                ...
                switch( ev.button.button ) {
                    ...
                    case SDL_BUTTON_RIGHT:
                        ...
                        break;
                    case SDL_BUTTON_MIDDLE:
                        last_input = sdl_mouse_button_event( MouseInput::MiddleButtonReleased );
                        break;
                    case SDL_BUTTON_X1:
