 ...
 * @param destination: optional finished-output selection, separate from the workbench;
 *                    omitted for camp/recipe-only selection.
 *
...
std::pair<Character *, const recipe *> select_crafter_and_crafting_recipe( int &batch_size_out,
        ...
        crafting_destination *destination = nullptr );
