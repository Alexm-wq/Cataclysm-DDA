...
void uistatedata::serialize( JsonOut &json ) const
{
    ...
    json.member( "crafting_browser_memorized_only", crafting_browser_memorized_only );
    json.member( "crafting_browser_unread_only", crafting_browser_unread_only );
    json.member( "crafting_browser_unread_first", crafting_browser_unread_first );
    json.member( "crafting_browser_category_scroll", crafting_browser_category_scroll );
    json.member( "crafting_browser_recipe_scroll", crafting_browser_recipe_scroll );
...
void uistatedata::deserialize( const JsonObject &jo )
{
    ...
    jo.read( "crafting_browser_memorized_only", crafting_browser_memorized_only );
    jo.read( "crafting_browser_unread_only", crafting_browser_unread_only );
    jo.read( "crafting_browser_unread_first", crafting_browser_unread_first );
    jo.read( "crafting_browser_category_scroll", crafting_browser_category_scroll );
    jo.read( "crafting_browser_recipe_scroll", crafting_browser_recipe_scroll );
