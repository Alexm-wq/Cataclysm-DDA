...
- The shared list renders one focus highlight for single-selection menus and clears stale hover on clicks/navigation/scrolling. Intentional multiple selections in refuel/siphon remain highlighted. Inline disabled hints and label-color overrides are provided by the helper rather than custom crafting controls.
